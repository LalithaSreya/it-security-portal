...
export default function TechnicianLayout() {
  ...
  // Route Guard: Block access if employee is not a Technician
  if (employee && employee.role !== 'Technician') {
    console.warn('Unauthorized access blocked. Redirecting to manager operational workspace...');
          ...
          <div className="flex items-center gap-4">
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent side="left" className="p-0 w-64 border-0">
                ...
                <TechnicianSidebar onCloseMobile={() => setMobileOpen(false)} />
              </SheetContent>
            </Sheet>
